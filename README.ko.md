...
[English](./README.md) · [한국어](./README.ko.md) · [Quickstart](./docs/quickstart.md) · [Showcase](./docs/showcase.md) · [프로젝트 준비 상태](./docs/meta/project-readiness.md) · [출시 체크리스트](./docs/meta/release-checklist.md) · [기여하기](./CONTRIBUTING.md) · [보안](./SECURITY.md)
...
2. **[copy-first showcase](./docs/showcase.md)**를 확인합니다.
3. starter file을 자신의 repository에 복사합니다.
4. 작은 GitHub Issue를 엽니다.
5. Jules가 focused pull request를 만들게 합니다.
6. PR을 review하고, CI를 확인한 뒤, maintainer가 만족할 때만 merge합니다.
...
- [Jules Web UI 가이드](./docs/jules-web-ui.md)
- [첫 기여 가이드](./docs/contributing/first-contributions.md)
- [번역 가이드](./docs/contributing/translations.md)
...
- **[Case Study B: English-Only Project Brief](./docs/case-studies/english-only-project.md)** — 글로벌 독자를 위한 작은 open-source project 실행 계획 문서.
