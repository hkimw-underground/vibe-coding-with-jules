...
- [ ] **No Promotional Language**: Documentation uses practical, non-promotional language. No mention of external rankings or "awesome" lists.
- [ ] **Jules Identity**: All documentation correctly refers to Jules as an "AI coding agent" or "managed contributor," never as a human contributor.
...
- [ ] **Branch Protection**: `main` branch has protection rules enabled (requires PR, human review, and passing CI).
