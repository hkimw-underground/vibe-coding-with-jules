...
- [ ] **No Promotional Language**: Documentation uses practical, non-promotional language without mentions of external rankings.
...
- [ ] **Case Study Clarity**: Status for [Case Study A](../case-studies/digital-logic-circuit.md) and [Case Study B](../case-studies/english-only-project.md) is clear and accurate.

## 3. Workflow & Safety
- [ ] **CI Status**: The `Validate docs and templates` workflow is passing on the `main` branch.
- [ ] **Branch Protection / Required Checks**: The `main` branch is protected by required PRs, human review, and passing status checks.
...
- [ ] **No Stale PRs**: All duplicate or stale PRs are closed with appropriate templated comments.
