...
- **GitHub Connection:** Similar to GitHub Actions Secrets, these allow Jules to operate in environments that require authentication.
...
- **GitHub Connection:** Functions like a cron job that automatically opens issues or PRs at set intervals.
...
- **GitHub Connection:** Directly maps to `git checkout -b`. Usually, this should be your default branch (e.g., `main`).
...
- **GitHub Connection:** Allows for a more "developer-centric" workflow while still connecting back to GitHub issues and PRs.
...
- **GitHub Connection:** Enables building "Level 5" or "Level 6" automation (see Workflow Levels).
